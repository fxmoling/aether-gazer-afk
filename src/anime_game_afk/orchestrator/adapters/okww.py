...
Command format: ``<exe> -t <task_index> -e``

* ``-t N``  selects the 1-based task index (default 1 = 日常一条龙)
* ``-e``    exits the process after the task completes
"""
...
class OkwwAdapter(BaseAdapter):
    ...
    def build_command(
        ...
        """Build command: ``<exe> -t <N> -e [extra_args...]``."""
