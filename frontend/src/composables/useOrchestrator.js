 ...
 * Manages tools, schedules, and run status for the multi-script scheduler.
 */
...
export const orchState = reactive({
  ...
  runStatus: null,    // Current run status object
  editing: null,      // Currently editing schedule id
})

// --- Tool metadata (hardcoded for MVP) ---
